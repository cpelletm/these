...
\caption{From the diamond to the NV center. a) Drawing of a bulk diamond\footnote{In this manuscript, we will consider any samples above $\sim$ 100 $\mu$m to be bulk.}. b) Drawing representing a fluorescence microscopy image of a diamond surface. The red fluorescent spots symbolize NV centers photoluminescence. c) Zoom on the crystalline structure of an NV center. Black balls represent carbon atoms}
\label{diamond+NV}
\end{figure}
