...
The aim of this first chapter is to introduce the tools and concepts needed to understand the next chapters.

This chapter will first cover the material aspects of NV centers by focusing on the creation process of synthetic diamonds and the required steps to create NV defects inside them. 

It will then cover the fundamentals of NV physics, including the NV center optical and spin properties, basic experiments with NV centers and the various relaxations times ($T_1$,$T_2$,$T_2^*$) which characterizes the NV center's spin. 

Finally it will introduce dipole-dipole coupling between two spins and the concept of cross-relaxation.

The three subjects that are the NV center physics, the diamond material aspects and the dipole-dipole interaction are at the heart of the work carried out in this thesis. 
...
We have covered in this introductory chapter every concepts needed to understand the results presented in the next chapter. We have seen the main steps in the creation of artificial diamonds and NV centers, we have covered the optical and spin properties of the NV center as well as the ways to measure them, and we have introduced the notion of dipole-dipole coupling and cross-relaxation between two spins.

The focus of chapter 2 will be on the cross-relaxation between NV centers and other spin impurities in CVD-grown diamond, while the focus of chapter 3 and 4 will be on the cross-relaxation between NV centers and other NV centers and their potential application in magnetometry.
\printbibliography
\end{document}
