...
\end{equation}
where $\gamma_f=1/T_1^f$ is the fluctuator decay rate. This number $\eta$ encapsulates both the geometry of the problem (through $g$ and $h$) and the resonance condition between the NV center and the fluctuator.
...
The fluctuator model provides another explanation: the fluctuator spectral response is broaden by its very short lifetime. This also explains why the $1/T_1^{\rm dd}$ line is well matched by a Lorentzian, while the ODMR lines are closer to Gaussians in our sample. 
