...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{Figures/NV-NV_equivalent}[h]
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{Figures/inhomogene_2_spins}[h]
\caption{label}
\label{inhomogene}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{Figures/Stretch_vs_pas_stretch}[h]
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{Figures/various_fit_formulae}[h]
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{Figures/betas}[h]
\label{betas}
