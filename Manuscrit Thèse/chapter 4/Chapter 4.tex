...
We can see that the SNR does not deviate from the $\sqrt{T}$ scaling for times up to 50 s, and could probably be extended much longer. The non-linearity for shorter times comes from the LIA low-pass filter.
...
comparaison microwave: le scan avec la microwave + zoom + les variances d'allan et trace temporelles.
Budker : mesurer vite deuf les pentes
champ tranverse : demerde toi
