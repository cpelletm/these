...
class Photon_Counter(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Photodiode")
    ...
    def start_measure(self):
        ...
        self.task.ai_channels.add_ai_voltage_chan("Dev1/ai11")
        self.task.timing.cfg_samp_clk_timing(1/self.dt,sample_mode=nidaqmx.constants.AcquisitionType.CONTINUOUS, samps_per_chan=2)
