...
class Photon_Counter(QMainWindow):
	...
	def start_measure(self):
		...
		self.tension.timing.cfg_samp_clk_timing(self.f_acq,sample_mode=nidaqmx.constants.AcquisitionType.FINITE, samps_per_chan=self.n_acq)


		self.tension.triggers.start_trigger.cfg_dig_edge_start_trig('/Dev1/PFI0')
		self.tension.triggers.start_trigger.retriggerable=True
