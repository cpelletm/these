...
class Photon_Counter(QMainWindow):
	def __init__(self):
		...
		self.labelf_meca=QLabel("f_meca")
		self.lectf_meca=QLineEdit(str(self.f_meca))
		Vbox_gauche.addWidget(self.labelf_meca)
		Vbox_gauche.addWidget(self.lectf_meca)

		self.labeln_cycle=QLabel("n_cycle")
