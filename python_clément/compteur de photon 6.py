...
class Photon_Counter(QMainWindow):
    def __init__(self):
        ...
        self.dt=0.03 # taux de rafraichissement de l'image

        self.n_points=10 # nombre de points pris par rafraichissement
    ...
    def update_canvas(self):       
        ...
        self.task.read(nidaqmx.constants.READ_ALL_AVAILABLE)
    ...
    def start_measure(self):
        ...
        self.N=np.int(self.textN.text())*self.n_points

        #Sample Clock creation (On counter1)

        self.sample_clock=nidaqmx.Task()
        self.sample_clock.co_channels.add_co_pulse_chan_freq('Dev1/ctr1', freq=1/self.dt*self.n_points)
        ...
        #Buffer creation
        self.data=np.zeros(self.n_points+1)
