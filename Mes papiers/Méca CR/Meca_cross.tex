...
\begin{figure}[!ht]
  \centering \scalebox{0.3}{\includegraphics{scan_adamas_121.eps}}
...
\begin{figure}[!ht]
  \centering \scalebox{0.4}{\includegraphics{T_1.eps}}
...
\begin{figure}[!ht]
  \centering \scalebox{0.13}{\includegraphics{dilutednv.eps}}
