...
To let the three salient features detach better from the spectrum, we fitted a 4th-order polynomial to the PL evolution, without the spectral bumps, and subtract it from the data. Further details on the fitting choices are provided in Sec.V of the SM \cite{SM_CR_CVD}.

In order to attribute the three features to their respective defects, we run a similar scan (Section 1 in the SM \cite{SM_CR_CVD}) on a type Ib electron irradiated HPHT diamond crystal with a NV concentration in the 5-20 ppm range. Only the first feature appeared. 
...
We obtain a factor of 6 improvement over the precision reported in \citep{cruddace2007magnetic} and attribute the second and third feature to cross relaxation between the NV center and the VH$^-$ and WAR1 defect. Scans along the [111] direction shown in the SM \cite{SM_CR_CVD} also corroborate this conclusion.
...
The modeling of this interaction is presented in the section 2 of the SM \cite{SM_CR_CVD}. The dotted lines in Fig. \ref{energy-levels} show the four transition frequencies of the first shell $^{13}$C coupled to an NV center. The crossings between the $|m_s=0\rangle$ to $|m_s=\pm 1\rangle$ NV transition and the four transitions of this  $^{13}$C-NV pair occur at magnetic field values around 20~G. 
...
\bibitem [{\citenamefont {Akhmedzhanov}\ \emph {et~al.}(2019)\citenamefont
  ...
  {NoStop}%
\bibitem [{SM_()}]{SM_CR_CVD}%
  \BibitemOpen
  \href@noop {} {\emph {\bibinfo {title} {See Supplemental Material at [URL
  will be inserted by publisher], which includes Refs. [22-26]}}}\BibitemShut
  {NoStop}%
...
\bibitem [{\citenamefont {Álvarez}\ \emph {et~al.}(2015)\citenamefont
  {Álvarez}, \citenamefont {Bretschneider}, \citenamefont {Fischer},
  \citenamefont {London}, \citenamefont {Kanda}, \citenamefont {Onoda},
  \citenamefont {Isoya}, \citenamefont {Gershoni},\ and\ \citenamefont
  {Frydman}}]{alvarez_local_2015}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {G.~A.}\ \bibnamefont
  {Álvarez}}, \bibinfo {author} {\bibfnamefont {C.~O.}\ \bibnamefont
  {Bretschneider}}, \bibinfo {author} {\bibfnamefont {R.}~\bibnamefont
  {Fischer}}, \bibinfo {author} {\bibfnamefont {P.}~\bibnamefont {London}},
  \bibinfo {author} {\bibfnamefont {H.}~\bibnamefont {Kanda}}, \bibinfo
  {author} {\bibfnamefont {S.}~\bibnamefont {Onoda}}, \bibinfo {author}
  {\bibfnamefont {J.}~\bibnamefont {Isoya}}, \bibinfo {author} {\bibfnamefont
  {D.}~\bibnamefont {Gershoni}}, \ and\ \bibinfo {author} {\bibfnamefont
  {L.}~\bibnamefont {Frydman}},\ }\href {\doibase 10.1038/ncomms9456}
  {\bibfield  {journal} {\bibinfo  {journal} {Nat Commun}\ }\textbf {\bibinfo
  {volume} {6}},\ \bibinfo {pages} {8456} (\bibinfo {year} {2015})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Jiang}\ \emph {et~al.}(2018)\citenamefont {Jiang},
  \citenamefont {Ye}, \citenamefont {Jiao}, \citenamefont {Huang},\ and\
  \citenamefont {Lv}}]{jiang2018estimation}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {F.-J.}\ \bibnamefont
  {Jiang}}, \bibinfo {author} {\bibfnamefont {J.-F.}\ \bibnamefont {Ye}},
  \bibinfo {author} {\bibfnamefont {Z.}~\bibnamefont {Jiao}}, \bibinfo {author}
  {\bibfnamefont {Z.-Y.}\ \bibnamefont {Huang}}, \ and\ \bibinfo {author}
  {\bibfnamefont {H.-J.}\ \bibnamefont {Lv}},\ }\href@noop {} {\bibfield
  {journal} {\bibinfo  {journal} {Chinese Physics B}\ }\textbf {\bibinfo
  {volume} {27}},\ \bibinfo {pages} {057601} (\bibinfo {year}
  {2018})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Kamp}\ \emph {et~al.}(2018)\citenamefont {Kamp},
  \citenamefont {Carvajal},\ and\ \citenamefont
  {Samarth}}]{kamp2018continuous}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {E.}~\bibnamefont
  {Kamp}}, \bibinfo {author} {\bibfnamefont {B.}~\bibnamefont {Carvajal}}, \
  and\ \bibinfo {author} {\bibfnamefont {N.}~\bibnamefont {Samarth}},\
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Physical Review
  B}\ }\textbf {\bibinfo {volume} {97}},\ \bibinfo {pages} {045204} (\bibinfo
  {year} {2018})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Lazda}\ \emph {et~al.}(2020)\citenamefont {Lazda},
  \citenamefont {Busaite}, \citenamefont {Berzins}, \citenamefont {Smits},
  \citenamefont {Auzinsh}, \citenamefont {Budker}, \citenamefont {Ferber},\
  and\ \citenamefont {Gahbauer}}]{lazda2020cross}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {R.}~\bibnamefont
  {Lazda}}, \bibinfo {author} {\bibfnamefont {L.}~\bibnamefont {Busaite}},
  \bibinfo {author} {\bibfnamefont {A.}~\bibnamefont {Berzins}}, \bibinfo
  {author} {\bibfnamefont {J.}~\bibnamefont {Smits}}, \bibinfo {author}
  {\bibfnamefont {M.}~\bibnamefont {Auzinsh}}, \bibinfo {author} {\bibfnamefont
  {D.}~\bibnamefont {Budker}}, \bibinfo {author} {\bibfnamefont
  {R.}~\bibnamefont {Ferber}}, \ and\ \bibinfo {author} {\bibfnamefont
  {F.}~\bibnamefont {Gahbauer}},\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {arXiv preprint arXiv:2007.00473}\ } (\bibinfo {year}
  {2020})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {van Oort}\ and\ \citenamefont
