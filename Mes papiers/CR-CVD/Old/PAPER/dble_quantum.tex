...
\begin{figure}[!ht]
  \centering {\includegraphics[width=0.40\textwidth]{Cristallo.eps}}
...
\begin{figure}[!ht]
  \centering {\includegraphics[width=0.4\textwidth]{map_full.eps}}
  \caption{a) 
...
\begin{figure}[!ht]
  \centering{\includegraphics[width=0.4\textwidth]{map_zoom.eps}}
  \caption{a) 
...
\begin{figure}[!ht]
  \centering{\includegraphics[width=0.40\textwidth]{Carte.eps}}
  \caption{a) 
...
\begin{figure}[!ht]
  \centering{\includegraphics[width=0.40\textwidth]{T_1.eps}}
  \caption{a) 
...
\begin{figure}[!ht]
  \centering {\includegraphics[width=0.40\textwidth]{R1_vs_J.pdf}}
  \caption{a) 
Lifetime saturation theory
 }
\end{figure}
...
\begin{figure}[!ht]
  \centering {\includegraphics[width=0.40\textwidth]{13C_transitions.eps}}
  \caption{Transitions of NV-13C and NV.
 }
\end{figure}
\begin{figure}[!ht]
  \centering {\includegraphics[width=0.40\textwidth]{transi_VH.eps}}
  \caption{Transitions of VH- and NV.
 }
\end{figure}
\begin{figure}[!ht]
  \centering {\includegraphics[width=0.40\textwidth]{rose_10V_13C.eps}}
