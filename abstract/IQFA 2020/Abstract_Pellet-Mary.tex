...
Figure 1 : \textit{Relaxation-based detection of dipolar interaction.} \textbf{Left} : Sketch of the various spins interacting. \textbf{Right} : Photoluminescence change while scanning the magnetic field along the crystalline [100] direction. Three dips are observed for the CR with $^{13}$C-NV, VH$^-$ and War1.

\begin{center}
\includegraphics[scale=.25]{CRmeca}
\end{center}

Figure 2 : \textit{Mechanical detection of dipolar interactions.} \textbf{Left} : Sketch of the experimental setup. \textbf{Right :} Angular position of the diamond while scanning B$_{\mathrm{Scan}}$ without a microwave. The rotation of the diamond at 17 G corresponds to the resonance between two classes of NV.
\end{abstract}
