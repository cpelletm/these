...
\includegraphics[scale=.30]{CR_111}\footfullcite{armstrong_nvnv_2010}
\end{frame}
...
\includegraphics[scale=.3]{Motivations}\footfullcite{tallaire2020high}
\end{frame}
\begin{frame}{Photoluminescence change with $\vec B$ in the [100] direction}
\centering
\includegraphics[scale=.45]{Scan_100_brut}
\end{frame}
...
\centering
\includegraphics[scale=.08]{CRmeca_121_mieux}
\end{frame}
\begin{frame}{Origin of the magnetic torque}
\centering
\includegraphics[scale=.23]{Explication_torque_alalouche}
\end{frame}
