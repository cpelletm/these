...
\begin{figure}
    \begin{overprint}
    \onslide<1>\centering\includegraphics[scale=.25]{projection_4_classes_0}
    \onslide<2>\centering\includegraphics[scale=.25]{projection_4_classes_1}
    \end{overprint}
\end{figure}
\end{frame}
...
\begin{figure}
    \begin{overprint}
    \onslide<1>\includegraphics[scale=.24]{NV-NV_1}
    \onslide<2>\includegraphics[scale=.24]{NV-NV_2}
    \end{overprint}
\end{figure}
\end{frame}
