...
\begin{center}
\includegraphics[width=0.65\textwidth,height=0.9\textheight,keepaspectratio]{diamant Alex}
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth,height=0.3\textheight,keepaspectratio]{dark spins}
\end{center}
$\bullet$ Mechanical detection of resonant dipolar coupling :
\begin{center}
\includegraphics[width=\textwidth,height=0.3\textheight,keepaspectratio]{Cr-meca}
\end{center}
\end{frame}
