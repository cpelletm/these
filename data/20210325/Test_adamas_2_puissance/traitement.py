...
x,y=extract_data('2.5mw.txt')
y=y/y[0]
plt.plot(x,y,label='2.5')

x,y=extract_data('1mw.txt')
y=y/y[0]
plt.plot(x,y,label='1')

x,y=extract_data('0.5mw.txt')
y=y/y[0]
plt.plot(x,y,label='0.5')

x,y=extract_data('0.25mw.txt')
y=y/y[0]
plt.plot(x,y,label='0.25')

x,y=extract_data('0.1mw.txt')
y=y/y[0]
