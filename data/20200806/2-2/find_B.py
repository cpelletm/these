...
# check_peaks()
ESR_01V=[2616,2711,2761,2841,2998,3063,3096,3154]
ESR_02V=[2629,2672,2777,2814,3027,3058,3133,3154]
ESR_03V=[2633,2651,2782,2805,3050,3073,3153,3170]
ESR_04V=[2592,2674,2754,2825,3054,3101,3152,3200]
ESR=ESR_02V
# print(find_B(ESR))
# print(err_func(find_B(ESR),ESR))
