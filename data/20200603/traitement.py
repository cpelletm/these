...
fname='tdv_nuit_1x1x1x1_laser_faible'
x,y=extract_data(fname+'.txt')
plt.plot(x,y,label=fname)
popt,yfit=stretch_soustraction(x,y)
plt.plot(x,yfit,label='stretch, tau=%f'%popt[1])
...
# fname='tdv_sans_champ_mag_court'
# x,y=extract_data(fname+'.txt')
# plt.plot(x,y,label=fname)
# popt,yfit=stretch_soustraction(x,y)
# plt.plot(x,yfit,label='stretch, tau=%f'%popt[1])

# fname='tdv_sans_champ_mag_gros_laser'
# x,y=extract_data(fname+'.txt')
# plt.plot(x,y,label=fname)
# popt,yfit=stretch_soustraction(x,y)
# plt.plot(x,yfit,label='stretch, tau=%f'%popt[1])

# fname='tdv_sans_champ_mag_plus_court_moins_tlect'
# x,y=extract_data(fname+'.txt')
# plt.plot(x,y,label=fname)
# popt,yfit=stretch_soustraction(x,y)
# plt.plot(x,yfit,label='stretch, tau=%f'%popt[1])
