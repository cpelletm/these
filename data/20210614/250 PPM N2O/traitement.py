...
# x,y=extract_data('T1 250 uW 2V random')
# x=x[1:]
# y=y[1:]
# y=y-min(y)
# y=y/max(y)
...
# plt.plot(x,yfit,label='random tau=%4.3E'%popt[2])

# x,y=extract_data('T1 250 uW 0V')
# x=x[1:]
# y=y[1:]
# y=y-min(y)
# y=y/max(y)
# plt.plot(x,y,'o',markerfacecolor="None")
# popt,yfit=stretch_exp_fit(x,y)
# plt.plot(x,yfit,label='0B tau=%4.3E'%popt[2])

# x,y=extract_data('T1 250 uW 2V 100')
# x=x[1:]
# y=y[1:]
# y=y-min(y)
# y=y/max(y)
# plt.plot(x,y,'o',markerfacecolor="None")
# popt,yfit=stretch_exp_fit(x,y)
# plt.plot(x,yfit,label='100 tau=%4.3E'%popt[2])

# x,y=extract_data('T1 250 uW 2V 2x2')
# x=x[1:]
# y=y[1:]
# y=y-min(y)
# y=y/max(y)
# plt.plot(x,y,'o',markerfacecolor="None")
# popt,yfit=stretch_exp_fit(x,y)
# plt.plot(x,yfit,label='2x2 tau=%4.3E'%popt[2])

# x,y=extract_data('T1 250 uW 2V 1x1x1x1')
# x=x[1:]
# y=y[1:]
# y=y-min(y)
# y=y/max(y)
# plt.plot(x,y,'o',markerfacecolor="None")
# popt,yfit=stretch_exp_fit(x,y)
# plt.plot(x,yfit,label='1x1x1x1 tau=%4.3E'%popt[2])
