...
xmax=-1
x,y=extract_data('ESR_correspond_DEER_2_classes.txt')
y=y/max(y)
x=x*1000
xpos=[2740,2766,2801,2831,2938,2958,2989,3013]
plt.plot(x,y,'o',markerfacecolor="None",ms=10,mew=3)
popt,yfit=ESR_n_pics(x,y,xpos)
plt.plot(x,yfit,lw=2)
ax=plt.gca()
ax.tick_params(labelsize=20)
ax.set_xlabel(r'Microwave frequency (MHz)', fontweight='bold' ,fontsize=20)
