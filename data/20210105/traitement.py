...
x,y=extract_data('ESR_0B_rose_0dB.txt')
y=y-min(y)
y=y/max(y)
x=x*1000
# plt.plot(x,y,'x')
centers=[2867,2874]
popt1,yfit=ESR_n_pics(x,y,centers)
plt.plot(x,yfit)
x,y=extract_data('ESR_0B_rose_-20dB.txt')
y=y-min(y)
y=y/max(y)
x=x*1000
# plt.plot(x,y,'x')
centers=[2867,2874]
popt2,yfit=ESR_n_pics(x,y,centers)
plt.plot(x,yfit)
print(popt1[1:3],popt2[1:3],popt1[1:3]-popt2[1:3])
plt.show()
